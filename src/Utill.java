...
public class Utill {
    ...
    public Map<String, Object> separationOperands(String inputString) throws UtillException, CalculatorImplException { // метод,возвращающий Мар с операндом (+,-,*,/)
